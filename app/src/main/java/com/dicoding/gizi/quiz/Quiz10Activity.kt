...
import com.dicoding.gizi.databinding.ActivityQuiz10Binding
...
class Quiz10Activity : AppCompatActivity() {
    private lateinit var binding: ActivityQuiz10Binding
...
//10. B
        ...
        binding.next.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                Intent(this, Menu11Activity::class.java).apply {
                    this.putExtra(Menu11Activity.EXTRA_TITLE, nilai)
                    startActivity(this)
                }
                finish()
            }, 500.toLong())
