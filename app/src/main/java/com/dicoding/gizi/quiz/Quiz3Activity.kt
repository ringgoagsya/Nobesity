...
import com.dicoding.gizi.databinding.ActivityQuiz3Binding
...
//10. B
        ...
        binding.next.setOnClickListener {
            var nilai = intent.getIntExtra(Quiz2Activity.EXTRA_TITLE,0)
            nilai = nilai!! + 10
            Handler(Looper.getMainLooper()).postDelayed({
                Intent(this, Quiz4Activity::class.java).apply {
                    this.putExtra(Quiz4Activity.EXTRA_TITLE, nilai)
                    startActivity(this)
                }
                finish()
            }, 500.toLong())
    ...
    private fun playAnimationBenar() {
        ...
        var nilai = intent.getIntExtra(Quiz1Activity.EXTRA_TITLE,0)
        nilai = nilai!! + 10
        Handler(Looper.getMainLooper()).postDelayed({
            Intent(this, Quiz4Activity::class.java).apply {
                this.putExtra(Quiz4Activity.EXTRA_TITLE, nilai)
