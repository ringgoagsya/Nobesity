...
import com.dicoding.gizi.databinding.ActivityQuiz7Binding
...
//10. B
        ...
        binding.next.setOnClickListener {
            var nilai = intent.getIntExtra(Quiz6Activity.EXTRA_TITLE,0)
            nilai = nilai!! + 10
            Handler(Looper.getMainLooper()).postDelayed({
                Intent(this, Quiz8Activity::class.java).apply {
                    this.putExtra(Quiz8Activity.EXTRA_TITLE, nilai)
                    startActivity(this)
                }
                finish()
            }, 500.toLong())
