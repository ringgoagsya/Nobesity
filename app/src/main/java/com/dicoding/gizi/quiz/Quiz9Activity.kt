...
import com.dicoding.gizi.databinding.ActivityQuiz9Binding

class Quiz9Activity : AppCompatActivity() {
    private lateinit var binding: ActivityQuiz9Binding
...
//10. B
        ...
        binding.next.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                Intent(this, Quiz10Activity::class.java).apply {
                    this.putExtra(Quiz10Activity.EXTRA_TITLE, nilai)
                    startActivity(this)
                }
                finish()
            }, 500.toLong())
