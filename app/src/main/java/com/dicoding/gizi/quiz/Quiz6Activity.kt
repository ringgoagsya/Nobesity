...
import com.dicoding.gizi.databinding.ActivityQuiz6Binding
...
//10. B
        ...
        binding.next.setOnClickListener {
            var nilai = intent.getIntExtra(Quiz5Activity.EXTRA_TITLE,0)
            nilai = nilai!! + 10
            Handler(Looper.getMainLooper()).postDelayed({
                Intent(this, Quiz7Activity::class.java).apply {
                    this.putExtra(Quiz7Activity.EXTRA_TITLE, nilai)
                    startActivity(this)
                }
                finish()
            }, 500.toLong())
